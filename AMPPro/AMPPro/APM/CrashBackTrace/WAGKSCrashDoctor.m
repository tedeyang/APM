...
@interface  WAGKSCrashDoctorParam: NSObject
...
@implementation WAGKSCrashDoctorParam
...
@interface WAGKSCrashDoctorFunctionCall: NSObject
...
@implementation WAGKSCrashDoctorFunctionCall
...
- (NSString*) descriptionForObjCCall
{
    ...
    WAGKSCrashDoctorParam* receiverParam = [self.params objectAtIndex:0];
    ...
    WAGKSCrashDoctorParam* selectorParam = [self.params objectAtIndex:1];
    ...
    for(int paramNum = 0; paramNum < paramCount; paramNum++)
    {
        ...
        if(paramNum < 2)
        {
            WAGKSCrashDoctorParam* param = [self.params objectAtIndex:(NSUInteger)paramNum + 2];
            if(param.value != nil)
            {
...
- (NSString*) descriptionWithParamCount:(int) paramCount
{
    ...
    {
        WAGKSCrashDoctorParam* param = [self.params objectAtIndex:(NSUInteger)i];
...
@implementation WAGKSCrashDoctor
...
- (WAGKSCrashDoctorFunctionCall*) lastFunctionCall:(NSDictionary*) report
{
    WAGKSCrashDoctorFunctionCall* function = [[WAGKSCrashDoctorFunctionCall alloc] init];
    ...
    {
        WAGKSCrashDoctorParam* param = [[WAGKSCrashDoctorParam alloc] init];
...
- (NSString*) zombieCall:(WAGKSCrashDoctorFunctionCall*) functionCall
{
...
- (NSString*) diagnoseCrash:(NSDictionary*) report
{
    @try
    {
        ...
        WAGKSCrashDoctorFunctionCall* functionCall = [self lastFunctionCall:report];
